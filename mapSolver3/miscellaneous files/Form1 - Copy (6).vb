...
startfound:
            ...
            Dim usefulforks As New List(Of coordinates) 'collects all forks, then removes the unused ones
            ...
            While gx < 1000
                ...
                Select Case nearforks.Count
                    ...
                    Case Else
                        ...
                        usefulforks.AddRange(nearforks)
            ...
            'remove all items of "forks" from "allforks"
            For Each m As coordinates In forks
                For i = usefulforks.Count - 1 To 0 Step -1
                    If m.x = usefulforks(i).x And m.y = usefulforks(i).y Then
                        usefulforks.RemoveAt(i)
                    End If
                Next
            Next
            ...
            For Each item As coordinates In usefulforks
